...
public final class Oi {
    ...
    public static final JoystickButton ELEVATORUP = new JoystickButton(AUX_JOYSTICK, 3);
    public static final JoystickButton ELEVATORDOWN = new JoystickButton(AUX_JOYSTICK, 5);
